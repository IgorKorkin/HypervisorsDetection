...
// 		TCHAR display_name[MAX_PATH];
	...
	public:
		...
		bool init(LPCTSTR driverName, LPCTSTR driverBinPath);
		...
		bool send_ctrl_code(HANDLE hDevice, DWORD ctrlCode, LPVOID inBuf, DWORD inBufSize, LPVOID outBuf, DWORD outBufSize, LPOVERLAPPED lpOverlapped);
		
		bool chk_service_active();
